            ...
            <div class="card-body">
                ...
                @csrf
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="number" name="joining_salary" id="joining_salary" class="form-control {{$errors->has('joining_salary')?'is-invalid':""}}" required>
                    ...
                    <a href="{{route('welcome')}}" class="btn btn-primary">Cancel</a>
                </form>
            </div>
            @endsection